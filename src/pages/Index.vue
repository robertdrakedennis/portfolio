      ...
      <div class="w-full text-center">
        <div class="relative mx-auto rounded-full h-48 w-48 border-gray-600 border-2 mb-4" style="padding: .375rem">
          <div class="rounded-full border-2 border-gray-600" style="padding: .375rem">
            <g-image src="https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/a2/a2b5904b3eff3d07039a6238eed1cc9f3c3814d2_full.jpg" alt="hero" class="rounded-full block" />
          </div>
        </div>
